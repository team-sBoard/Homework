...
namespace SellingAuto_s.Data
{
    ...
    {
        public static void CreateAllStores(Cars car1_1, Cars car1_2, Cars car2_1, Cars car2_2, out Stores store1_1, out Stores store1_2, out Stores store2_1, out Stores store2_2)
        {
            store1_1 = CreateStore1_1(car1_1);
            store1_1.DisplayStore();
            store1_2 = CreateStore1_2(car1_2);
            store1_2.DisplayStore();
            store2_1 = CreateStore2_1(car2_1);
            store2_1.DisplayStore();
            store2_2 = CreateStore2_2(car2_2);
        ...
        public static void CreateAllCities(Stores store1_1, Stores store1_2, Stores store2_1, Stores store2_2, out Cities city1, out Cities city2)
        {
            city1 = CreateCity1(store1_1, store1_2);
            city1.DisplayCity();
            city2 = CreateCity2(store2_1, store2_2);
            city2.DisplayCity();
